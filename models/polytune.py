# Modified from https://github.com/huggingface/transformers/blob/main/src/transformers/models/t5/modeling_t5.py
#
# coding=utf-8
...
class T5ForConditionalGeneration(T5PreTrainedModel):
    ...
    def generate(self, mistake_inputs, score_inputs, max_length=1024, output_hidden_states=False, **kwargs):
        ...
        for l in range(max_length):
            ...
            decoder_input_ids_start = torch.cat(
                [decoder_input_ids_start, next_tokens], dim=-1
            )
...
class T5Stack(T5PreTrainedModel):
    ...
    def forward(
        ...
        # encoder hidden states should be none for our usage
